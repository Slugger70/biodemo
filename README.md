...
Simon changed this bit to force a travis build
...
This program is released as open source software under the terms of [MIT License](https://raw.githubusercontent.com/Slugger70/biodemo/master/LICENSE).

# Installing

Clone this repository: 
```
$ git clone https://github.com/Slugger70/biodemo
```
...
[biodemo issue tracker](https://github.com/Slugger70/biodemo/issues)
